      ...
      <div className="bg-slate-900 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="relative p-6 border-b border-slate-800">
          ...
          <p className="text-slate-400 text-sm mt-1">
            {mode === 'login'
              ...
              : 'Start creating viral thumbnails today'}
          </p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white hover:bg-slate-100 text-slate-900 font-semibold rounded-lg transition-colors disabled:opacity-50"
          >
